...
- **Card back** — Original or Promo for Marvel Champions; for the other games, whichever back sets the imported exports brought (for example *original* and *alep*). Applied per card type automatically (player, encounter, villain / quest).
